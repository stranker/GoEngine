...
Card3D::Card3D() {
	...
	spatialMaterial = ResourceManager::LoadSpatialMaterial("Shaders/FoilShader.vs", "Shaders/FoilShader.fs", "cardMaterial");
	...
	//noise = ResourceManager::LoadTexture("card_noise_2.png", "card_noise_2");
	//foil = ResourceManager::LoadTexture("pokemon_card_foil.jpg", "pokemon_card_foil");
	foil = ResourceManager::LoadTexture("holo_gradient_1.jpg", "pokemon_card_foil");
	...
	spatialMaterial->AddTexture("foil_texture", foil);
